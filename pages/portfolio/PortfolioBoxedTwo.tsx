  ...
  return (
    <Loader>
      ...
      <section className="pt-100 pt-100">
        <Portfolio filter="true" columns="2" layout="box" space={undefined} items={undefined} classAppend={undefined} children={undefined} />
      </section>
...
export default PortfolioBoxedTwo;
