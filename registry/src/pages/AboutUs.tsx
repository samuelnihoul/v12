...
export default function AboutUs() {
    return (
        <div className='w-100' style={{backgroundImage:'url(/assets/images/crabs.jpg)',height:'100vh',backgroundSize:'auto 100%',backgroundRepeat:'no-repeat'}}>
            ...
            <div >
                <div>
                    <h2>We work hard to soothe our planet's fever with quality and affordable offsets. We designed an hybrid CO2 offset marketplace with both fiat and blockchain integration, enabling optimal user experience and overall reliability</h2>
                </div>
