    ...
    <div className="container">
      <div className="row">
        <HeadingSection
          ...
          We are an innovation-driving environmental services company. Our flagship service is our web3 carbon offset marketplace Karbon Basar. With an ever growing number of climate-friendly and innovative features, it aims to play a key part in bringing the world to a net-zero carbon well before 2050 (2030?). 
        </HeadingSection>
      </div>
